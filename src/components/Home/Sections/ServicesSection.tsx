...
function ServicesSection() {
  ...
  const Services: IService[] = [
    ...
    {
      icon: <IconBrandWechat size={100} stroke={1} className="text-green-500"/>,
  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-y-4 items-center justify-center">
        ...
        <div className="self-start h-full text-subheading w-full text-center">
        ...
        <div className="grid grid-cols-3 gap-4 w-full h-full">
          {Services.map((service, index) => (
            <div
              key={index}
              className="bg-white group relative p-4 rounded-md shadow-md flex flex-col items-center justify-center border border-slate-400 cursor-pointer"
            >
